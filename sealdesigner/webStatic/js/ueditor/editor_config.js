...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:"/Seal/ueditor_scrawlUp"           //涂鸦上传地址
        ,scrawlPath:""                           //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:"/Seal/ueditor_fileup"               //附件上传提交地址
        ,filePath:""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:"/Seal/ueditor_getRemoteImage"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:"/Seal/ueditor_imageManager"       //图片在线管理的处理地址
        ,imageManagerPath:""                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: "/Seal/ueditor_imgup" //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/jsp/snapImgUp.jsp"”
        ,snapscreenPath: ""
        ...
        ,wordImageUrl:"/Seal/ueditor_imgup"
        ,wordImagePath:""                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:"/Seal/ueditor_getMovie"                   //视频数据获取地址

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        ,toolbars:[     //根据项目需要进行了修改
            [ 'source', '|', 'undo', 'redo', '|',
                ...
                'imagecenter', '|', 'insertimage', 'emotion','scrawl', 'insertvideo', 'attachment','pagebreak','template','background', '|',
